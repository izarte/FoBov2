...
for i in range (10000):
    ...
    p.stepSimulation()
    p.setJointMotorControl2(bodyIndex=robot_id, jointIndex=1, controlMode=p.VELOCITY_CONTROL, targetVelocity=2)
    p.setJointMotorControl2(bodyIndex=robot_id, jointIndex=3, controlMode=p.VELOCITY_CONTROL, targetVelocity=-2)
    time.sleep(1./240.)
